...
const OurServicesSection: React.FC<ServiceClientsProps> = ({ className }) => {
    ...
    >
      ...
      >
        <div className="pt-8 pb-4 w-full lg:absolute lg:bottom-0 lg:left-[7%] lg:-rotate-90 origin-bottom-left">
          <CustomMarquee title="OUR SERVICES" />
        </div>
        <div className="flex w-full flex-col gap-2 h-full col-span-11">
          <div
            className=" lg:w-7/12 p-4 flex flex-col lg:flex-row gap-2 lg:gap-8 items-center"
            ref={followHeadingRef}
          >
            <h3 className="uppercase text-2xl font-bold text-primary lg:w-7/12 w-full">
              Cutting Edge Solutions
            </h3>
            <div className="w-12 border-b border-foreground hidden lg:block" />
            <p className="text-foreground/80">
              We develop holistic strategies & digital with experience empower
              people don’t company position
            </p>
          </div>
        </div>
        <div className="lg:absolute lg:top-[15%] lg:left-1/2 w-full h-full">
          <div
            className="flex flex-wrap lg:flex-nowrap gap-6 relative my-32 items-center justify-center lg:overflow-auto lg:w-full lg:right-40 lg:pl-96"
            ref={ServiceCardsRef}
          >
