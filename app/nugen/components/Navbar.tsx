  ...
  return (
    <>
      ...
      <Button
        className="px-4 md:px-8 uppercase max-md:text-black hover:text-white active:text-white"
        variant="ghost"
        onClick={() => onClick("/nugen/featured-client")}
        disabled={btnStatus}
      >
        Clients
      </Button>
      <Button
        className="px-4 md:px-8 uppercase max-md:text-black hover:text-white active:text-white"
        variant="ghost"
        onClick={() => onClick("/nugen/featured-work-section")}
        disabled={btnStatus}
      >
        Work
      </Button>
      <Button
        className="px-4 md:px-8 uppercase max-md:text-black hover:text-white active:text-white"
        variant="ghost"
        onClick={() => onClick("/nugen/our-services-section")}
        disabled={btnStatus}
      >
        Services
      </Button>
      <Button
        className="px-4 md:px-8 uppercase max-md:text-black hover:text-white active:text-white"
        variant="ghost"
        onClick={() => onClick("/nugen/testimonial-section")}
        disabled={btnStatus}
      >
        TESTIMONIALS
      </Button>
      <Button
        className="px-4 md:px-8 uppercase max-md:text-black hover:text-white active:text-white"
        variant="ghost"
        onClick={() => onClick("/nugen/service-section")}
        disabled={btnStatus}
      >
        Work with US
      </Button>
      <Button
        className="px-4 md:px-8 uppercase max-md:text-black hover:text-white active:text-white"
        variant="ghost"
        onClick={() => onClick("/nugen/subscribe-section")}
        disabled={btnStatus}
      >
        Contact Us
      </Button>
