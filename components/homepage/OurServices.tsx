    ...
    >
      <div className="flex flex-col items-center relative w-full h-full">
        <motion.div
          ...
          className="w-full text-center text-4xl md:text-6xl capitalize font-serif font-bold text-primary mb-4"
        >
          Our Services
        </motion.div>
                  ...
                  >
                    <div className="relative flex flex-col items-center p-4">
                      <motion.h2
                        ...
                        className="font-extrabold text-xl text-center group-hover:text-[#ff366b] transition-colors duration-300 capitalize font-serif text-primary"
                      >
                        {value?.button_title || ""}
                      </motion.h2>
                      <motion.div
